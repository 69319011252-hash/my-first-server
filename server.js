 ...
 res.end('<h1>สวัสดีครับ! นี่คือ Web Server ของ [นางสาวกชกร โถชัย 69319011252]</h1><p>เครื่องแม่ขายทํางานปกติบนระบบ Railway แล้วครับผม!</p>');
 });

 // 4. สั่งให้เซิร์ฟเวอร์เริ่มต้นเปิดรับฟังการเชื่อมต่อตาม Port ที่กําหนดไว้
 server.listen(port, () => {
 console.log(`Server is running! เครื่องแม้ข่ายเปิดทํางานแล้วที่ช่องทาง: ${port}`);
 });
